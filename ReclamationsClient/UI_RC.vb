Public Class UI_RC
    ...
    Private Sub Cmb_Clients_KeyUp(sender As Object, e As EventArgs) Handles Cmb_Clients.KeyUp

        Cmb_Clients.Items.Clear()
        Cmb_Clients.Select(Cmb_Clients.Text.Length, 0)
        _lesClients = _maClsSQLReclamationClient.readLesClientsByCode(Cmb_Clients.Text)
    ...
    Private Sub Cmb_Clients_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Cmb_Clients.SelectedIndexChanged
        Dim result = From cli In _lesClients
                     Where cli._Code.Equals(Cmb_Clients.Text) 'marche pô !
